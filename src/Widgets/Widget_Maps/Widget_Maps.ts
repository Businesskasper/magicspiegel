...
export class Maps extends Widget {
  ...
  public Load(): void {
    let routeToShow = this.GetRelevantRoute(
      <MapsWidgetSettings>this.WidgetSettings
    );
    if (routeToShow !== null) {
      this.DisplayTravelTime(
        routeToShow.From,
        routeToShow.To,
        routeToShow.TravelMode,
        this.Div,
        (<MapsWidgetSettings>this.WidgetSettings).GoogleApiKey
      );
    }
  }
  ...
  private GetRelevantRoute(widgetSettings: MapsWidgetSettings): any {
    ...
    //Route1
    if (
      widgetSettings.To1 !== null &&
      widgetSettings.To1 !== undefined &&
      widgetSettings.To1.trim() !== "" &&
      widgetSettings.From !== null &&
      widgetSettings.From !== undefined &&
      widgetSettings.From.trim() !== "" &&
      widgetSettings.Until1 !== null &&
      widgetSettings.Until1 !== undefined &&
      widgetSettings.Until1.trim() !== "" &&
      widgetSettings.Until1.split(":")[0].trim() !== "" &&
      widgetSettings.Until1.split(":")[0].trim() !== ""
    ) {
      ...
      if (new Date() < startDate) {
        return {
          ...
          To: widgetSettings.To1,
          TravelMode: widgetSettings.TravelMode1,
        };
      }
    }
    ...
    //Route2
    if (
      widgetSettings.To2 !== null &&
      widgetSettings.To2 !== undefined &&
      widgetSettings.To2.trim() !== "" &&
      widgetSettings.From !== null &&
      widgetSettings.From !== undefined &&
      widgetSettings.From.trim() !== "" &&
      widgetSettings.Until2 !== null &&
      widgetSettings.Until2 !== undefined &&
      widgetSettings.Until2.trim() !== "" &&
      widgetSettings.Until2.split(":")[0].trim() !== "" &&
      widgetSettings.Until2.split(":")[0].trim() !== ""
    ) {
      ...
      if (new Date() < startDate) {
        return {
          From: widgetSettings.From,
          To: widgetSettings.To2,
          TravelMode: widgetSettings.TravelMode2,
        };
      }
    }
