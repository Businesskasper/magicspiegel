...
export class Clock extends Widget {
  ...
  public Load(): void {
    this.Div.innerHTML += `<div id="clock.time" style="font-family:Helvetica; font-size:100px; line-height:100px; height:100px; color:white"></div>
